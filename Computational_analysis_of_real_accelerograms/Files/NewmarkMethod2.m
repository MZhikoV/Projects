function [disp,vel,acc,EI_nmrk,EI_abs] = NewmarkMethod2(M,K,C,P,beta,gamma,T_rec_end,dt_rec,disp_g,vel_g)
...
for i = 1:nt
    ...
    d_P_cherta(i)=dp(i)+a*vel(i)+b*acc(i);
...
acc(i+1)=(P(i)-C*vel(i)-K*disp(i))/M;
